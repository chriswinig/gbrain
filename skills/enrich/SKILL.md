...
Follow `skills/conventions/quality.md` and `skills/_brain-filing-rules.md` for filing, notability, citations, source precedence, and mandatory back-linking before enriching pages.
